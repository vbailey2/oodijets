...
outname="/sphenix/user/vbailey/ooanalysis/analysis/JS-Jet/OODijets/offline/hists/histMC.root"
root -b -q /sphenix/user/vbailey/ooanalysis/analysis/JS-Jet/OODijets/offline/getDijets.C\(\"$inname\",\"$outname\",1\)
